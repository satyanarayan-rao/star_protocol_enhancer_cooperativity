...
roi_id=$4
awk 'NR%3==1' $1 | grep -w "^${roi_id}" | grep "99~147" > ${2}.fp.99.tsv 
awk 'NR%3==1' $1 | grep -w "^${roi_id}" | grep "83~163" > ${2}.fp.83.tsv 
awk 'NR%3==2' $1 | grep -w "^${roi_id}" | grep "99~147" > ${3}.mvec.99.tsv 
awk 'NR%3==2' $1 | grep -w "^${roi_id}" | grep "83~163" > ${3}.mvec.83.tsv 
