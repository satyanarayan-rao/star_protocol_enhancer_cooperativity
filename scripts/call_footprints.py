...
def call_footprints(methylation_vec): 
    ...
    if len (upper_case_loc)>=2: # check if at least two upper case letters are there in the string
        for l in upper_case_loc:
            start_x = max(0, l) # 4 - 2 = 2
            end_x = min (l + 1, vec_len) # 4 + 3 = 7 # will fill x from 2 to 6 for `$` at 4
...
#out_fp = open(sys.argv[1], "w") 
#footprint_length_fp = open(sys.argv[2], "w")

for line in sys.stdin:
    # example line: 
    # chr2L	11806729	11806730	chr2L:11806729-11806729^20	.	+	chr2L	11806559	11806843	SRR3133326.1452842_1452842/1_overlapping`83~163	.	....................z....z.H..x.h..x.h.zx.h.zx....zx.h...................h............h..h.h..x...h.h.z.h.........z....x...x........x...........h......h..ZxhhhH.........Z.....................Xh...H.....HH..X...X..Xhh.......H..h.h........H....H..Z..........h.................x......Z.H.	<bsseq>
    d_loc = [m.start() for m in re.finditer("\t", line)]
    methylation_vec = line[d_loc[-2] + 1: d_loc[-1]]
    footprint_vec, footrprint_length_dict = call_footprints(methylation_vec) 
    to_write = line[0:d_loc[-2]] + "\t" + footprint_vec + "\t" + methylation_vec + "\t" + line[d_loc[-1] + 1: len(line) - 1]
    print(to_write)
     
    #for k in footrprint_length_dict:
    #    to_write = "\t".join([ line[0:d_loc[-2]], k, str(footrprint_length_dict[k])])
